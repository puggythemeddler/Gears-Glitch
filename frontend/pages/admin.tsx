...
const COMMON_FEATURES = [
  ...
  "Repair ticketing", "Analytics dashboard", "API access",
  "Custom branding", "Priority support", "Bulk import/export",
  "Multiple staff accounts", "M-Pesa integration",

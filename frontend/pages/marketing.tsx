...
const FEATURES = [
  ...
  { icon: "🌐", name: "Online Storefront", desc: "5 storefront layouts (Original, Amazon-style, Jumia-style, Mobile, Custom) plus a runtime JSON layout builder for admin-created custom themes. Admin-controllable hero sections (on/off toggle, theme-aware background that follows each visitor's device dark/light theme, and per-theme custom color pickers), live stats from your data, auto-synced category chips, product catalog, auto-rotating carousels, springboard category menu, and an About Us page with owner-editable content." },
  { icon: "🚀", name: "Marketing-Ready Hero", desc: "Turn your homepage hero into a conversion machine: a sale countdown timer that vanishes when the offer ends, rotating headline variants, a WhatsApp chat CTA using your store number, a payment & delivery trust strip (M-Pesa, cards, delivery, warranty), and sale/rating/low-stock badges on featured products — plus animated count-up live stats and a personalized greeting for logged-in customers. Every element has an admin one-click toggle. The hero auto-matches each visitor's dark/light theme, and you can set your own background colors for light and dark themes with automatic text contrast." },
  ...
  { icon: "📝", name: "Audit Log", desc: "Every admin and owner action is recorded — who created/updated/deleted what, when, and from where. Filterable by user, action, and entity, with a detail view for each entry. Accessible from the Activity group in the staff portal." },

...
const STATUS_GLOSSARY: { term: string; meaning: string }[] = [
  ...
  { term: "Purchase order — pending / ordered / received", meaning: "Supplier order lifecycle. Pending waits for the order to be placed; ordered means it has been sent to the supplier; received adds the ordered stock to inventory (serial-tracked lines can take scanned or auto-generated serials). Use the Recall button to fully reverse a receipt — stock is deducted and the order returns to ordered." },
  { term: "Purchase order — trash / restore", meaning: "Deleting a PO moves it to the Deleted tab where it can be restored. If the PO had added stock, deleting reverses that stock and voids its in-stock serials first. The trash keeps the order until you hard-delete it." },
  { term: "Serial number — in_stock / sold / voided", meaning: "A serial-tracked product's unit identifier. Generated from a category prefix or scanned at the point of sale, linked to a sale, and used for warranty lookups. Voiding removes it from usable stock." },

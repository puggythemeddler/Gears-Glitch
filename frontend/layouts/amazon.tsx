...
export function LayoutStyles() {
  return <style>{`
    ...
    .amz-top-inner { max-width: 1200px; margin: 0 auto; padding: 0.75rem 1rem; display: flex; align-items: center; gap: 1rem; flex-wrap: wrap; }
    ...
    .amz-nav { max-width: 1200px; margin: 0 auto; padding: 0.5rem 1rem; display: flex; gap: 0.25rem; flex-wrap: wrap; }
    ...
    .amz-hero { max-width: 1200px; margin: 1rem auto; padding: 0 1rem; display: grid; grid-template-columns: 2fr 1fr; gap: 1rem; }
    ...
    .amz-section { max-width: 1200px; margin: 2rem auto; padding: 0 1rem; }
    ...
    .amz-banner-row { display: grid; grid-template-columns: repeat(3, 1fr); gap: 1rem; max-width: 1200px; margin: 1.5rem auto; padding: 0 1rem; }

...
export function LayoutStyles() {
  return <style>{`
    ...
    .mob-header-inner { max-width: 1200px; margin: 0 auto; padding: 0.75rem 1rem; display: flex; align-items: center; justify-content: space-between; gap: 1rem; flex-wrap: wrap; }
    ...
    .mob-hero { max-width: 1200px; margin: 1.5rem auto; padding: 0 1rem; border-radius: 16px; overflow: hidden; position: relative; }
    ...
    .mob-brands { max-width: 1200px; margin: 2rem auto; padding: 0 1rem; }
    ...
    .mob-section { max-width: 1200px; margin: 2.5rem auto; padding: 0 1rem; }
    ...
    .mob-features { max-width: 1200px; margin: 2rem auto; padding: 0 1rem; display: grid; grid-template-columns: repeat(4, 1fr); gap: 1rem; }
    ...
    .mob-accessories { max-width: 1200px; margin: 2.5rem auto; padding: 0 1rem; }

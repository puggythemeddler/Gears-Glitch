...
export function LayoutStyles() {
  return <style>{`
    ...
    .jum-header-inner { max-width: 1200px; margin: 0 auto; padding: 0.75rem 1rem; display: flex; align-items: center; gap: 1rem; flex-wrap: wrap; }
    ...
    .jum-cat-icons { max-width: 1200px; margin: 1rem auto; padding: 0 1rem; display: flex; gap: 0.75rem; overflow-x: auto; flex-wrap: nowrap; }
    ...
    .jum-slider { max-width: 1200px; margin: 1rem auto; padding: 0 1rem; border-radius: 12px; overflow: hidden; position: relative; }
    ...
    .jum-section { max-width: 1200px; margin: 2rem auto; padding: 0 1rem; }
      ...
      <div className="jum-header">
        <div className="jum-header-inner">
          <Link href="/" className="jum-brand">
            {settings?.storeLogo ? <img src={settings.storeLogo} alt="Store" style={{ height: 32 }} /> : settings?.storeName || "Store"}
          </Link>

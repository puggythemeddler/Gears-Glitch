...
function ensureDefaultSubscriptionPlans(): void {
  ...
  insert.run("starter", "Starter", "For individual shoppers exploring the catalog", 0, 0, 10, 1, JSON.stringify(["Product listing", "Product reviews & ratings", "Wishlist", "Price alerts"]));
  insert.run("basic", "Basic", "For small business owners and resellers", 2500, 1, 100, 2, JSON.stringify(["Product listing", "Product reviews & ratings", "Order management", "Customer management", "Discount/coupon management", "Email notifications", "Branch management", "Low stock alerts"]));
  insert.run("pro", "Professional", "For medium enterprises with multiple branches", 7500, 2, 500, 5, JSON.stringify(["Product listing", "Product reviews & ratings", "Order management", "Customer management", "Analytics dashboard", "Repair ticketing", "Messaging", "Branch management", "Multi-branch support", "Supplier management", "Low stock alerts", "API access", "Discount/coupon management", "Email notifications", "SMS notifications"]));
  insert.run("premium", "Premium", "For large businesses needing full integration", 15000, 3, 2000, 10, JSON.stringify(["Product listing", "Product reviews & ratings", "Order management", "Customer management", "Analytics dashboard", "Repair ticketing", "Messaging", "Branch management", "Multi-branch support", "Supplier management", "Low stock alerts", "API access", "Discount/coupon management", "Email notifications", "SMS notifications", "Multi-currency support", "POS integration", "Bulk import/export", "Bulk product edit", "Price history tracking", "Stock take / inventory count", "Stock transfers", "Purchase order management", "Quotations", "Dedicated account manager"]));
  insert.run("enterprise", "Enterprise", "Unlimited everything with white-glove service", 35000, 4, null, -1, JSON.stringify(["Product listing", "Product reviews & ratings", "Order management", "Customer management", "Analytics dashboard", "Repair ticketing", "Messaging", "Branch management", "Multi-branch support", "Supplier management", "Low stock alerts", "API access", "Discount/coupon management", "Email notifications", "SMS notifications", "Multi-currency support", "POS integration", "Bulk import/export", "Bulk product edit", "Price history tracking", "Stock take / inventory count", "Stock transfers", "Purchase order management", "Quotations", "Dedicated account manager", "eTIMS/KRA compliance", "Audit log", "Spec templates", "Google Sign-In", "Custom branding", "Payment method configuration", "Shop subscription", "Theme customization", "Client/tenant management", "Priority support", "Returns management"]));
}
...
function provisionClientDb(clientId: number, dbPath?: string): Database.Database {
  ...
  insertPlan.run("starter", "Starter", "Free plan for small businesses", 0, 0, 20, 1, JSON.stringify(["Product listing", "Product reviews & ratings"]));
  insertPlan.run("basic", "Basic", "Access to essential products", 29.99, 1, 50, 2, JSON.stringify(["Product listing", "Product reviews & ratings", "Order management", "Customer management", "Email notifications", "Branch management"]));
  insertPlan.run("pro", "Professional", "Full product access for growing businesses", 99.99, 2, 200, 5, JSON.stringify(["Product listing", "Product reviews & ratings", "Order management", "Customer management", "Analytics dashboard", "Messaging", "Branch management", "Discount/coupon management", "Low stock alerts", "Supplier management", "Bulk import/export"]));
  insertPlan.run("enterprise", "Enterprise", "Unlimited access with premium support", 299.99, 3, null, -1, JSON.stringify(["Product listing", "Product reviews & ratings", "Order management", "Customer management", "Analytics dashboard", "Repair ticketing", "Messaging", "Branch management", "Multi-branch support", "Discount/coupon management", "Low stock alerts", "Supplier management", "Bulk import/export", "Bulk product edit", "API access", "Multi-currency support", "POS integration", "Stock take / inventory count", "Stock transfers", "Quotations", "eTIMS/KRA compliance", "Audit log", "Price history tracking", "Spec templates", "Google Sign-In", "Dedicated account manager"]));

...
- **Control plane CSP** — The control plane serves with a Content Security Policy (scripts/styles inline only, images from `https:` for QR codes, `frame-ancestors 'none'` to block clickjacking, `object-src 'none'`).

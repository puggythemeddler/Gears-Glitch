...
- **Improved sidebar groupings** — Admin sidebar reorganized into 6 focused groups: Sales, Stock, Team (Users, Roles, Clients, Branches), Finance (Invoices, Credit Notes, Plans, Providers), Activity (Messages, Reviews, Reports), and Settings. Owner sidebar converted from flat list to grouped nav with Operations, Finance, Service, Stock, and Settings groups.

...
These are the current action points for the project, organized by priority. You can copy these into GitHub Issues or a project board with labels like `major`, `medium`, and `low`.
